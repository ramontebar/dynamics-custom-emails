...
{
    [TestClass]
    public class TestCreateCustomEmailFromQueue : WFActivityIntegrationTest
    {
        #region Properties
        ...
        protected override string AsyncOperationName
        {
            get
            {
                return "Create Custom Email From Queue";
            }
        }
        ...
        [TestMethod]
        public void RunTestCreateCustomEmailFromQueue()
        {
            base.Test();
        }
