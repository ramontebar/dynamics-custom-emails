...
namespace DXTools.CRM.Solutions.CustomEmails.IntegrationTests.Actions
{
    ...
    /// </summary>
    [TestClass]
    public class SendCustomEmailTest_AllowDuplicates : XrmIntegrationTest
    {
        #region Local Test Variables

        private Entity payment;
        private string rowEmailSubject1 = "DXTools - Integration Test - Template 1 - SendCustomEmailTest_AllowDuplicates - SUBJECT - ";
        private string rowEmailBody1 = "DXTools - Integration Test - Template 1 - SendCustomEmailTest_AllowDuplicates - BODY - ";
        private string rowEmailSubject2 = "DXTools - Integration Test - Template 2 - SendCustomEmailTest_AllowDuplicates - SUBJECT - ";
        private string rowEmailBody2 = "DXTools - Integration Test - Template 2 - SendCustomEmailTest_AllowDuplicates - BODY - ";
        #endregion
        ...
        private Entity CreatePayment(Entity contact)
        {
            ...
            newRecord["dxtools_subject"] = "Integration Test - SendCustomEmailTest_AllowDuplicates at " + DateTime.Now;
        ...
        [TestMethod]
        public void Test_SendCustomEmailTest_AllowDuplicates()
        {
            base.Test();
        }
        ...
        protected override void Verify()
        {
            ...
            Assert.IsTrue(emailAttachmentCollection.Entities.Count == 2);

            EntityReference attachment1 = emailAttachmentCollection.Entities[0]["attachmentid"] as EntityReference;
            EntityReference attachment2 = emailAttachmentCollection.Entities[1]["attachmentid"] as EntityReference;
            Assert.AreNotEqual(attachment1.Id, attachment2.Id);
        }
