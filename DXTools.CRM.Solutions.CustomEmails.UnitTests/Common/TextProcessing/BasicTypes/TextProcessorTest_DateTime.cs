...
{
    [TestClass]
    public class TextProcessorTest_DateTime
    {
        [TestMethod]
        public void TestTextProcessor_DateTime()
        {
            using (ShimsContext.Create())
            {
                Entity recordContext = new Entity("dxtools_payment");
                recordContext["createdon"] = DateTime.Now;
                ...
                string inputText = "Your payment was created on {createdon}, thanks. ";
